        ...
        >
            ...
            <nav className="mt-6">
                <ul>
                    ...
                    <li>
                        <button
                            className={`flex items-center w-full py-3 px-4 rounded-md hover:bg-gray-700 transition duration-200 ${
                                isSystemsOpen ? "bg-gray-800" : ""
                            }`}
                        ...
                        {isSystemsOpen && (
                            <ul className="ml-6 mt-1 bg-gray-800">
                                ...
                                <SidebarItem href="/test3" text="Properties" icon={<FiGrid />} isOpen={isOpen} />
                                <SidebarItem href="/" text="Menus" icon={<FiGrid />} isOpen={isOpen} active />
                                <SidebarItem href="/test2" text="API List" icon={<FiGrid />} isOpen={isOpen} />
                            </ul>
                        )}
                    </li>

                    {/* Other Folder Items */}
                    <SidebarItem href="/" text="Users & Groups" icon={<FaFolder />} isOpen={isOpen} />
                    <SidebarItem href="/" text="Competition" icon={<FaFolder />} isOpen={isOpen} />
                </ul>
            </nav>
        </div>
    );
...
const SidebarItem = ({
    ...
    <li
        className={`flex items-center py-3 px-4 rounded-md transition duration-200 ${
            active ? "bg-green-500" : "hover:bg-gray-700"
        }`}
    >
        {icon}
        {isOpen && (
